...
## Corpus Check
- 793 files · ~728,539 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4826 nodes · 4971 edges · 665 communities detected
...
8. `GTMSessionFetcherService` - 61 edges
9. `GIDSignIn` - 45 edges
...
Cohesion: 0.01
Nodes (428): components/item_detail_dialogs.dart, components/item_detail_footer.dart, components/item_detail_scroll_body.dart, ../../constants/app_colors.dart, dart:io, AppColors, build, main (+420 more)
...
Cohesion: 0.02
Nodes (119): ../../../auth/widgets/constants.dart, ../../../auth/widgets/custom_button.dart, action, _authenticate, AuthPrompt, BackButton, build, dispose (+111 more)
...
Cohesion: 0.06
Nodes (33): ARTStats, -dateFromInProgress, -dateFromIntervalId, -granularityFromIntervalId, -initWithAllinboundoutboundpersistedconnectionschannelsapiRequeststokenRequestspushesinProgresscountintervalId, -intervalFormatString, -intervalGranularity, -intervalTime (+25 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (32): ARTPush, -activate, -admin, -deactivate, -didFailToRegisterForLocationNotificationsWithErrorrealtime, -didFailToRegisterForLocationNotificationsWithErrorrest, -didFailToRegisterForRemoteNotificationsWithErrorrealtime, -didFailToRegisterForRemoteNotificationsWithErrorrest (+24 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (31): ARTRestChannel, -annotations, -history, -historycallbackerror, -initWithInternalqueuedDealloc, -name, -options, -presence (+23 more)
...
Cohesion: 0.06
Nodes (30): ARTErrorInfo, -cause, -createFromNSError, -createFromNSException, -createFromNSExceptionrequestId, -createUnknownError, -createWithCodemessage, -createWithCodemessageadditionalUserInfo (+22 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (30): ARTEvent, -initWithPresenceSyncState, -newWithPresenceSyncState, ARTRealtimePresence, -enter, -entercallback, -enterClientdata, -enterClientdatacallback (+22 more)
...
Cohesion: 0.07
Nodes (28): ARTPushActivationDeviceIdentityEvent, -encodeWithCoder, -initWithCoder, -initWithIdentityTokenDetails, -new, -newWithIdentityTokenDetails, ARTPushActivationErrorEvent, -encodeWithCoder (+20 more)

### Community 31 - "Community 31"
Cohesion: 0.07
Nodes (28): ARTCbcCipher, -cbcCipherWithParamslogger, -cipherName, -decryptoutput, -encryptoutput, -initWithCipherParamslogger, -keyLength, ARTCipherParams (+20 more)
...
Cohesion: 0.1
Nodes (19): ARTSRProxyConnect, -_configureProxy, -dealloc, -_dequeueInput, -_didConnect, -_failWithError, -_fetchPACwithProxySettings, -_initializeStreams (+11 more)

### Community 46 - "Community 46"
Cohesion: 0.1
Nodes (19): GACAppCheckErrorUtil, -APIErrorWithHTTPResponsedata, -APIErrorWithNetworkError, -appAttestAttestationResponseErrorWithMissingField, -appAttestAttestKeyFailedWithErrorkeyIdclientDataHash, -appAttestGenerateAssertionFailedWithErrorkeyIdclientDataHash, -appAttestGenerateKeyFailedWithError, -appAttestKeyIDNotFound (+11 more)

### Community 47 - "Community 47"
Cohesion: 0.1
Nodes (19): GTMGatherInputStream, -absoluteOffset, -close, -delegate, -getBufferlength, -hasBytesAvailable, -initWithDataArray, -open (+11 more)
...
Cohesion: 0.12
Nodes (16): ARTRestChannels, -exists, -get, -getoptions, -initWithInternalqueuedDealloc, -iterate, -release, ARTRestChannelsInternal (+8 more)
...
## Knowledge Gaps
- **3176 isolated node(s):** `main`, `main`, `package:flutter_test/flutter_test.dart`, `package:launchfast/main.dart`, `-registerWithRegistry` (+3171 more)
